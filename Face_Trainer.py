...
for root, dirs, files in os.walk(r"C:\Users\rithv\OneDrive\Desktop\Face-Detection-on-Raspberry-Pi-main\Face_Images"):  # go to the face image directory
    for file in files:  # check every directory in it
        if True:  # for image files ending with jpeg, jpg or png
            ...
            Gery_Image = Image.open(path).convert("L")  # convert the image to grayscale using Pillow
